...
- Данное задание у меня не вышло, хотя, судя по всему, все сделано правильно.
- Вот блок из docker-compose.yml для telegraf:
...
- Вот конфиг-файл, который пробрасывается в контейнер и модуль для docker input:
...
- Контейнеры, само-собой, рестартил после внесения изменений. Что я делаю не так?
